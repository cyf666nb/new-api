...
Vue 3 + Vite port of the static `demo/` pages.
...
`bun run generate` rebuilds `src/generated/pages.ts` from the source HTML files in `../../demo`.

## Routes

The app keeps the original demo URLs, for example:
...
Clean aliases such as `/pricing` and `/dashboard` are also available.
=======
<div align="center">
...
MIT
>>>>>>> f6475f10ec8de67868f0a07596634a74c0eac734
